...
public class DeleteEmployeeFrame extends JFrame {
    ...
    private void deleteEmployee() {
        ...
        try {
            ...
            statusLabel.setText(deleted ? "Employee successfuly deleted!" : "Employee not found!");

        } catch (Exception ex) {
            JOptionPane.showMessageDialog(this, "Error deleting employee! Double check the information");
        }
    }
}
